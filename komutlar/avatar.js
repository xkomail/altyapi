...
if (mention != null || mention != undefined) {
  ...
  .addField('Test | Avatar Sistemi', `[Avatarın büyük halini göster!](${mention.avatarURL})`, false);
  message.react("����");
  ...
  .addField('Test | Avatar Sistemi', `[Avatarın büyük halini göster!](${message.author.avatarURL})`, false);
